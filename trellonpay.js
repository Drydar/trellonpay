...
const firebaseConfig = {
  ...
  storageBucket: "trellonpay.appspot.com",
...
function displayMessage(message, type = 'info') {
    ...
    if (type === 'error') {
        ...
        messageEl.style.backgroundColor = 'none';
        messageEl.style.color = 'yellowgreen';
        messageEl.style.border = 'none';
        messageEl.style.fontSize = '20px'
        messageEl.style.borderRadius = '9px';
        messageEl.style.fontWeight = '600';
...
if (document.getElementById('fullName')) {
  ...
  if (user) {
    ...
    if (userDoc.exists()) {
      ...
      document.getElementById('fullName').innerText = userData.username || "No name";
      document.getElementById('pointsDisplay').innerText = userData.amount ?? 0;
      document.getElementById('userEmail').innerText = userData.email || user.email || "No email";
